...
/**
 * Strings for component 'theme_agnostic', language 'en'
 *
...
$string['pluginname'] = 'Agnostic';
$string['address'] = 'Address';
$string['choosereadme'] = '<div class="clearfix"><div class="theme_screenshot">
<img class=img-polaroid src="agnostic/pix/screenshot.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle Agnostic Theme</h3>
<p> This theme is based on the Boost based Moodle theme. </p>
<p>Authors: Agnostic Team<br>
Contact: info@agnosy.org<br>
Website: <a href="http://agnosy.org">agnosy.org</a><br> </p>';
$string['configtitle'] = 'Agnostic';
...
$string['phone'] = "Phone";
$string['privacy:metadata'] = 'The agnostic theme does not store any personal data about any user.';
