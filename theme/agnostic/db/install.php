...
/**
 * Theme_agnostic install function.
 *
 * @return void
 */

function xmldb_theme_agnostic_install() {
    global $CFG;
    ...
    // Slider images.
        ...
        $filerecord->component = 'theme_agnostic';
        ...
        $fs->create_file_from_pathname($filerecord, $CFG->dirroot . '/theme/agnostic/pix/home/slide1.jpg');
}
