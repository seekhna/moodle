 ...
 * @return string
 */
function agnostic_marketingspot() {
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_agnostic_get_setting('mspot'.$i.'icon');
        $msptitle = theme_agnostic_get_setting('mspot'.$i.'title');
        $mspdescription = theme_agnostic_get_setting('mspot'.$i.'desc');
    ...
    for ($i = 1; $i <= 4; $i++) {
        $mspicon = theme_agnostic_get_setting('mspot'.$i.'icon');
        $msptitle = theme_agnostic_get_setting('mspot'.$i.'title');
        $msptitle = theme_agnostic_lang($msptitle);
        $mspdescription = theme_agnostic_get_setting('mspot'.$i.'desc');
        $mspdescription = theme_agnostic_lang($mspdescription);
